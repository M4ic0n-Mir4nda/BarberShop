...
public interface IUserService {
    ...
    UserData getUserById(UserRequestPayload payload, UUID id) throws NotFoundRecordsException;

    Employe updateEmploye(EmployeRequestPayload payload, UUID employeId) throws NotFoundRecordsException;
